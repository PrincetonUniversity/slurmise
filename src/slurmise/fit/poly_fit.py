...
class PolynomialFit(ResourceFit):
    ...
    _runtime_model_name: str = "poly_runtime_model.pkl"
    _memory_model_name: str = "poly_memory_model.pkl"
    ...
    def load(cls, query: JobData | None = None, path: str | None = None) -> PolynomialFit:
        ...
        runtime_model = fit_obj.path / "poly_runtime_model.pkl"
        fit_obj.runtime_model = joblib.load(str(runtime_model)) if runtime_model.exists() else None

        memory_model = fit_obj.path / "poly_memory_model.pkl"
